    ...
    <div class="min-h-screen bg-gradient-to-br from-[#0a1628] via-[#0d1b2e] to-[#0a1628]">
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center justify-between mb-8">
          <div>
            <h1 class="text-3xl font-bold text-white mb-2">Editar Cliente</h1>
            <p class="text-blue-300">Modifica la información del cliente</p>
          </div>
          <Link
        ...
        <div class="bg-black/20 backdrop-blur-xl rounded-xl border border-blue-500/30 overflow-hidden">
          <div class="px-8 py-6 border-b border-blue-500/30">
            <h3 class="text-xl font-semibold text-white">Información del Cliente</h3>
            <p class="text-blue-300 mt-1">Modifica los campos que desees actualizar</p>
          </div>

          <form @submit.prevent="submit" class="p-8 space-y-8">
            <!-- Nombre -->
            <div>
              <label for="nombre" class="block text-sm font-medium text-blue-300 mb-3">
                Nombre *
              </label>
              <div class="relative">
                <input
              ...
              <div class="flex justify-between items-center mt-1">
                ...
                <p class="text-sm text-blue-300">{{ form.nombre.length }}/60 caracteres</p>
              </div>
            </div>

            <!-- Apellidos -->
            <div>
              <label for="apellidos" class="block text-sm font-medium text-blue-300 mb-3">
                Apellidos
              </label>
              <div class="relative">
                <input
              ...
              <div class="flex justify-between items-center mt-1">
                ...
                <p class="text-sm text-blue-300">{{ form.apellidos.length }}/100 caracteres</p>
              </div>
            </div>

            <!-- CI -->
            <div>
              <label for="ci" class="block text-sm font-medium text-blue-300 mb-3">
                CI/NIT
              </label>
              <div class="relative">
                <input
              ...
              <div class="flex justify-between items-center mt-1">
                ...
                <p class="text-sm text-blue-300">{{ form.ci.length }}/20 caracteres</p>
              </div>
            </div>

            <!-- Teléfono -->
            <div>
              <label for="telefono" class="block text-sm font-medium text-blue-300 mb-3">
                Teléfono *
              </label>
              <div class="relative">
                <input
            ...
            <!-- Botones -->
            <div class="flex justify-end space-x-4 pt-6 border-t border-blue-500/30">
              <Link
                :href="route('clientes.index')"
                class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
              ...
              <button
                ...
                class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
              >
