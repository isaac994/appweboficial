<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-[#0a1628] via-[#0d1b2e] to-[#0a1628] py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-blue-300">Selecciona los productos que deseas comprar</p>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                >
                    ...
                    <div class="space-y-2">
                        <h3 class="text-lg font-semibold text-white">{{ getProductoNombre(producto) }}</h3>
                        ...
                        <div class="flex justify-between items-center pt-2">
                            <div>
                                ...
                                <span class="ml-1 font-semibold text-blue-400">
                    ...
                    <div class="mt-4">
                        <button
                            ...
                            :class="carrito.includes(producto.id_producto)
                                ? 'w-full px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors duration-200 flex items-center justify-center'
                                : 'w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200 flex items-center justify-center'"
                        >
        ...
        >
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold text-white">Carrito de Compra</h3>
                <button
            ...
            <div class="space-y-2 mb-4 max-h-40 overflow-y-auto">
                ...
                >
                    <span class="text-white">{{ getProductoNombre(obtenerProducto(productoId)) || 'Producto' }}</span>
...
const productosFiltrados = computed(() => {
    ...
    if (filtros.value.texto) {
        ...
        productos = productos.filter(producto => {
            // Para Accesorio Simple, buscar principalmente en la descripción
            if (producto.categoria?.nombre?.toLowerCase().includes('accesorio simple')) {
                return producto.descripcion?.toLowerCase().includes(texto) || false
            }

            // Para otras categorías, buscar en todos los campos
            return (producto.nombre?.toLowerCase().includes(texto) || false) ||
...
const getProductoNombre = (producto: Producto) => {
    ...
    // Para otras categorías, devolver "Marca Modelo"
...
const completarCompra = () => {
    ...
    sessionStorage.setItem('productos_compra', JSON.stringify(productosSeleccionados))

    // Redirigir a la interfaz de compra
    router.visit(route('compras.create'))
}
</script>
