      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-black/20 backdrop-blur-xl rounded-xl border border-purple-500/30 p-6 mb-8">
          <div class="mb-4">
            ...
            <p class="text-purple-300 text-sm">El buscador permite filtrar por nombre y descripción de la categoría</p>
          </div>
            ...
            <div class="flex-1">
              <div class="relative">
                ...
                <input
                  ...
                  title="Busca por nombre de la categoría o descripción"
                />
              </div>
            </div>
            <button
        ...
        <div v-if="!categorias || categorias.length === 0" class="text-center py-12">
          <div class="bg-black/20 backdrop-blur-xl rounded-xl border border-purple-500/30 p-8">
            ...
            <p class="text-purple-300 mb-4">No se encontraron categorías que coincidan con tu búsqueda.</p>
            <Link
              :href="route('categorias.create')"
