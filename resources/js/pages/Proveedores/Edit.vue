      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex justify-between items-center mb-8">
          <div>
            ...
            <p class="text-gray-300 mt-2">Modifica la información del proveedor</p>
          </div>
          <Link
        ...
        <!-- Formulario -->
        <div v-if="proveedor" class="bg-black/20 backdrop-blur-sm rounded-xl border border-purple-500/30 p-8">
        ...
        <!-- Loading State -->
        <div v-else class="bg-black/20 backdrop-blur-sm rounded-xl border border-purple-500/30 p-8">
          <div class="flex items-center justify-center">
            <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-purple-600"></div>
            <span class="ml-3 text-gray-600">Cargando datos del proveedor...</span>
          </div>
        </div>
      </div>
    </div>
...
const submitForm = () => {
  ...
  form.put(route('proveedores.update', props.proveedor?.id_proveedor), {
    onSuccess: () => {
