          ...
          <form @submit.prevent="submitForm">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                />
                <p v-if="form.errors.telefono" class="mt-1 text-sm text-red-400">{{ form.errors.telefono }}</p>
              </div>
              ...
              <div>
                ...
                />
                <p v-if="form.errors.correo" class="mt-1 text-sm text-red-400">{{ form.errors.correo }}</p>
              </div>
              ...
              <div class="md:col-span-2">
                ...
                ></textarea>
                <p v-if="form.errors.direccion" class="mt-1 text-sm text-red-400">{{ form.errors.direccion }}</p>
              </div>
            </div>
