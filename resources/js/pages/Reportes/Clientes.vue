    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center justify-between mb-8">
          <div>
            <h1 class="text-3xl font-bold text-white mb-2">Reporte de Clientes</h1>
            <p class="text-purple-300">Genera reportes detallados de clientes con filtros avanzados</p>
          </div>
          <button
...
const generarReporte = async () => {
  ...
  try {
    const response = await fetch(route('reportes.generar-clientes'), {
      method: 'POST',
      headers: {
...
const descargarPdf = () => {
  if (pdfData.value) {
    ...
    link.download = pdfData.value.filename || 'reporte_clientes.pdf';
