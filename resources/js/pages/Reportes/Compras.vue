    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center justify-between mb-8">
          <div>
            <h1 class="text-3xl font-bold text-white mb-2">Reporte de Compras</h1>
            <p class="text-purple-300">Genera reportes detallados de compras con filtros por período y proveedor</p>
          </div>
          <button
        ...
        <div class="bg-black/20 backdrop-blur-xl rounded-xl border border-purple-500/30 p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <!-- Período Inicial -->
            <div>
              <label class="block text-sm font-medium text-purple-300 mb-2">Período Inicial</label>
              <input
            ...
            <!-- Período Final -->
            <div>
              <label class="block text-sm font-medium text-purple-300 mb-2">Período Final</label>
              <input
          ...
          <div class="border-t border-purple-500/30 pt-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <!-- Proveedor -->
              <div>
                <label class="block text-sm font-medium text-purple-300 mb-2">Proveedor</label>
                <select
              ...
              <!-- Ordenar por -->
              <div>
                <label class="block text-sm font-medium text-purple-300 mb-2">Ordenar por</label>
                <select
              ...
              <div class="bg-white border-b">
                ...
                <div class="flex items-center justify-between p-3 bg-gray-800 text-white">
                  <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-3">
                      <span class="text-sm text-gray-300">Documento: {{ pdfData?.filename || 'reporte_compras.pdf' }}</span>
...
const generarReporte = async () => {
  ...
  try {
    const response = await fetch(route('reportes.compras.generar'), {
      method: 'POST',
      headers: {
...
const descargarPdf = () => {
  if (pdfData.value) {
    ...
    link.download = pdfData.value.filename || 'reporte_compras.pdf';
