    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center justify-between mb-8">
          <div>
            <h1 class="text-3xl font-bold text-white mb-2">Reporte de Productos</h1>
            <p class="text-purple-300">Genera reportes detallados de productos con filtros avanzados</p>
          </div>
          <button
        ...
        <div class="bg-black/20 backdrop-blur-xl rounded-xl border border-purple-500/30 p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <!-- Categoría -->
            <div>
              <label class="block text-sm font-medium text-purple-300 mb-2">Categoría</label>
              <select
            ...
            <!-- Estado -->
            <div>
              <label class="block text-sm font-medium text-purple-300 mb-2">Estado</label>
              <select
          ...
          <div class="border-t border-purple-500/30 pt-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <!-- Marca -->
              <div>
                <label class="block text-sm font-medium text-purple-300 mb-2">Marca</label>
                              <select
...
const generarReporte = async () => {
  ...
  try {
    const response = await fetch(route('reportes.productos.generar'), {
      method: 'POST',
      headers: {
...
const descargarPdf = () => {
  if (pdfData.value) {
    ...
    link.download = pdfData.value.filename || 'reporte_productos.pdf';
